 ...
 */
export declare const getRawCommits: (filepath: string, cwd: string) => Promise<RawCommit[]>;
export declare const mergeRawCommits: (commits: RawCommit[]) => MergedRawCommit[];
export declare const getCommits: (filepaths: string[], cwd: string) => Promise<MergedRawCommit[]>;
